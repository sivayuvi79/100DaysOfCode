...
<!-- Day 10 -->
<h2 id="Day10"> :small_orange_diamond: Day 10: Problem Solving</h2>

<p>Given an unsorted array of integers, return the length of the longest consecutive elements sequence.</p>

<pre><code>$ python ProblemSolving.py </code></pre>
